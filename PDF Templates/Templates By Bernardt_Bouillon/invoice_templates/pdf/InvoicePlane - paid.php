...
<head>
	...
	<!--<?php foreach ($invoice_tax_rates as $invoice_tax_rate) : ?>
        <?php echo($show_item_discounts ? 'colspan="5"' : 'colspan="4"'); ?>
		<?php echo htmlsc($invoice_tax_rate->invoice_tax_rate_name) . ' (' . format_amount($invoice_tax_rate->invoice_tax_rate_percent) . '%)'; ?>
        <?php $tax= ($invoice_tax_rate->invoice_tax_rate_amount); echo format_currency($tax); ?>
        <?php endforeach ?>-->
</head>
<body>
<header class="clearfix">
    ...
    <div id="client">
        ...
        <?php if ($invoice->client_surname) {
            echo '<div>' . trans('') . 'Att: ' . $invoice->client_surname . '</div>';
        }
...
<main>
	...
	<h1 class="invoice-title text-green"><?php if (!isset($tax)) {echo 'Invoice';}else {echo 'Tax Invoice';} echo ' ' . $invoice->invoice_number;?></h1>
