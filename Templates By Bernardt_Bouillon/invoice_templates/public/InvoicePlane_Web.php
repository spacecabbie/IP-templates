...
<div class="container">
    <div id="content">
        ...
        <div class="webpreview-header">
            <h2><?php if (!isset($tax)) {echo 'Invoice';}else {echo 'Tax Invoice';} ?>&nbsp;<?php echo $invoice->invoice_number; ?></h2>
        ...
        <div class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6 col-lg-5 text-right">
                    ...
                    <p><?php if ($invoice->client_surname) {
                            echo lang("att") . ": " . $invoice->client_surname . '<br>';
                        } ?>
